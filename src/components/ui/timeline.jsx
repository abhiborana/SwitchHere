...
export const Timeline = ({ title, data }) => {
	...
	return (
		<div
			className="w-full bg-neutral-50 font-sans dark:bg-neutral-950 md:px-10"
			ref={containerRef}
		>
			<div
				ref={ref}
			...
			>
				{data.map((item, index) => (
					...
					>
						<div className="sticky top-0 z-40 flex max-w-xs flex-col items-center self-start md:w-full md:flex-row lg:max-w-sm">
